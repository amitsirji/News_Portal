...
//debug($rdata);
   // when click on delete link this will be called and delete image from database
	...
	@unlink($adminpath .'slide'. $rdata['image']);
	@unlink($adminpath .'thumb'.$rdata['image']);
   
    $sql1="delete from banner where  id='".$_GET['id']."'";
    ...
    if($q1)
    {
        ...
        echo "<script>alert('Banner Image Delete Succesfully'); window.location='index.php?p=viewbanner';</script>";
    }
                                ...
                                <tr class="odd">
                                    ...
                                    <td class="actions ">
                                        <div class="action-buttons">
                                            <a class="table-actions" href=""><i class="fa fa-eye"></i></a><a class="table-actions" href="index.php?p=editbanner&id=<?php echo $r['id'] ?>"><i class="fa fa-pencil"></i></a><a class="table-actions" href="index.php?p=viewbanner&del=Yes&id=<?php echo $r['id']; ?>"><i class="fa fa-trash-o"></i></a>
                                        </div>
                                    </td>
                                </tr>
                                <?php } ?>
