...
//       debug($_FILES);
    ...
    if ($q)
        echo "<script>alert('Banner Images Updated'); window.location='index.php?p=viewbanner';</script>";
}
...
if ($_GET['del']) {   // when click on delete link this will be called and delete image from database
    ...
    $q = mysql_query($sql);
    echo "<script>alert('Image Updated'); window.location='index.php?p=editbanner&id=" . $_GET['id'] . "';</script>";
}
?>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="widget-container fluid-height clearfix">
                <div class="heading">
                    <i class="fa fa-table"></i>Edit Home Page banner
                </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-7">
                <input class="form-control" name="heading" type="text" value="<?php echo $rdata['heading'];?>"/>
            </div>
          </div>
